...
namespace ServiceTool.Legacy.REM
{
    ...
    {
        static readonly uint[] crc16_table = {
            0x0000,
            0x8005,
            0x800F,
            0x000A,
        ...
        /**
		    ...
		    - Parameters:
		        - lpBuff: Data
		        - ulLength: Length of data
		        - usCRC: CRC seed
		 
		    - Returns: Calculated CRC
		 
		 */
        public static ushort CRC16(byte[] lpBuff, ulong ulLength, ushort usCRC)
        {

            int buffInterator = 0;
            ulong messageSize = ulLength;
            ushort crc = usCRC;
            byte myCharacter;
            ...
            {
                messageSize -= 1;
                myCharacter = lpBuff[buffInterator];

                crc = ((ushort) (crc16_table[((crc >> 8) & (0xFF))] ^ ((crc << 8) ^ (myCharacter))));
                buffInterator += 1;
            }
